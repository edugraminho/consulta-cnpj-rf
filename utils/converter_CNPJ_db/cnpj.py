...
from utils.converter_CNPJ_db.cfwf import read_cfwf
...
Exemplos: python cnpj.py "db/F.K032001K.D81106D" sqlite "output"
          python cnpj.py "db" sqlite "output" --dir
          python cnpj.py "db" sqlite "output" --dir --noindex
          python cnpj.py "db" csv "output" --dir
    ''')
